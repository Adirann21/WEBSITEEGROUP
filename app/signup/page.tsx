    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="flex min-h-[calc(100vh-73px)]">
          ...
          <div className="w-full max-w-md">
            ...
            <form className="space-y-6">
              ...
              <div className="flex justify-center pt-4">
                <Button
                  type="submit"
                  className="px-8 py-2 bg-black text-white rounded-md hover:bg-gray-800"
                >
                  Sign Up
                </Button>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 mb-4">Or use below to create account</p>
              
              <div className="flex justify-center gap-4">
                {/* Google */}
                <button type="button" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50">
        ...
        <div className="hidden md:block w-1/2 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-300 via-pink-200 to-orange-200" />
        </div>
      </main>
    </div>
  )
